                                        ...
                                        <div class="form-item">
                                            ...
                                            <select class="form-control" id="province" name="province"
                                                ...
                                                @foreach($provinces['data'] as $items)
                                                    <option
                                                        value="{{ $items['ProvinceID'] }} - {{ $items['ProvinceName'] }}"
                                                        {{ old('province', $user->province) == $items['ProvinceID'] . ' - ' . $items['ProvinceName'] ? 'selected' : '' }}>
                                                        {{ $items['ProvinceName'] }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-xl-4">
                                        <div class="form-item">
                                            ...
                                            <select class="form-control" id="district" name="district">
                                                ...
                                                <!-- Bạn cần thêm logic để load các quận/huyện theo tỉnh đã chọn -->
                                            </select>
                                            @error('district')
                                            <small id="title" class="form-text text-danger">{{ $message }}</small>
                                            @enderror
                                    ...
                                    <div class="col-xl-4">
                                        <div class="form-item">
                                            ...
                                            <select class="form-control" id="ward" name="ward"
                                                ...
                                                <!-- Bạn cần thêm logic để load các phường/xã theo quận/huyện đã chọn -->
                                            </select>
                                            @error('ward')
                                            <small id="title" class="form-text text-danger">{{ $message }}</small>
                                            @enderror
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div id="holder" style="margin-top:15px; max-height:100px;">
                                        ...
                                        @if (old('avatar', $user->avatar))
                                            <img src="{{ old('avatar', $user->avatar) }}" style="max-height:100px;">
                                        @endif
                                    </div>
