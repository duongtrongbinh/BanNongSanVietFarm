                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('post.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <!-- Cột cho Title -->
                            <div class="col-md-6">
                                <label for="inputText" class="form-label">Tiêu đề</label>
                        ...
                        <div class="row mb-3">
                            <div class="col-12">
                                ...
                                <textarea class="form-control my-editor-tinymce4" name="content"
                                          placeholder="Nhập content ...">{{ old('content') }}</textarea>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-12 text-end">
                                <a href="{{ route('post.index') }}" class="btn btn-info me-2">Quay Lại</a>
